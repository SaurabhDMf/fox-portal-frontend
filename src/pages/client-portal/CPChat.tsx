      ...
      <div className={`flex-1 flex flex-col min-w-0 ${!activeRoom ? 'hidden md:flex' : 'flex'}`}>
        {activeRoom ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-muted-foreground gap-3">
            ...
            <p className="text-xs">or start a new message with your team</p>
            <button
              onClick={() => setShowCreateDM(true)}
              className="mt-2 px-4 py-2 rounded-lg bg-primary text-primary-foreground text-sm font-medium hover:opacity-90 transition-all"
            >
              New Message
            </button>
          </div>
